...
class TestConfigurationDirectory:
    ...
    def test_get_config_dir_macos(self, mock_home, mock_is_macos, mock_is_windows, mock_makedirs):
        ...
        expected = Path("/Users/test") / "Library" / "Application Support" / "CommandRex"
    ...
    @patch('commandrex.config.settings.os.environ.get')
    @patch('commandrex.config.settings.Path.home')
    def test_get_config_dir_linux_with_xdg(self, mock_home, mock_env_get, mock_is_macos, mock_is_windows, mock_makedirs):
    ...
    @patch('commandrex.config.settings.os.environ.get')
    @patch('commandrex.config.settings.Path.home')
    def test_get_config_dir_linux_without_xdg(self, mock_home, mock_env_get, mock_is_macos, mock_is_windows, mock_makedirs):
...
class TestSecuritySettings:
    ...
    def test_is_dangerous_command_allowed_file_operations_allowed(self, isolated_settings):
    ...
    def test_is_dangerous_command_allowed_file_operations_denied(self, isolated_settings):
...
class TestGlobalSettingsInstance:
    ...
    def test_global_settings_import(self):
        ...
        # Note: We can't test the exact model value since it may have been modified by other tests
        assert "api" in settings.settings
