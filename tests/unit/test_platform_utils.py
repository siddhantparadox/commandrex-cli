...
class TestPlatformInfo:
    ...
    def test_get_platform_info_complete(self, mock_detect_shell, mock_python_version,
    ...
    @patch('platform.python_version')
    @patch('commandrex.executor.platform_utils.detect_shell')
    def test_get_platform_info_no_shell(self, mock_detect_shell, mock_python_version,
                                      mock_machine, mock_system):
...
class TestShellDetection:
    ...
    def test_detect_shell_from_environment_success(self, mock_capabilities, mock_env_detect):
    ...
    @patch('commandrex.executor.platform_utils.get_shell_capabilities')
    def test_detect_shell_fallback_to_commands(self, mock_capabilities, mock_cmd_detect, mock_env_detect):
    ...
    @patch('commandrex.executor.platform_utils.get_shell_capabilities')
    def test_detect_shell_fallback_to_behavior(self, mock_capabilities, mock_behavior_detect,
                                             mock_cmd_detect, mock_env_detect):
    ...
    @patch('commandrex.executor.platform_utils.get_shell_capabilities')
    def test_detect_shell_best_guess_fallback(self, mock_capabilities, mock_best_guess,
                                            mock_behavior_detect, mock_cmd_detect, mock_env_detect):
...
class TestShellDetectionFromEnvironment:
    ...
    def test_detect_shell_windows_cmd_from_parent(self, mock_parent_info, mock_is_windows):
    ...
    def test_detect_shell_windows_powershell_from_parent(self, mock_run, mock_parent_info, mock_is_windows):
        """Test PowerShell detection from parent process on Windows."""
        mock_is_windows.return_value = True
        mock_parent_info.return_value = ("powershell.exe", "C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe")
    ...
    def test_detect_shell_from_shell_env_var(self, mock_get_version, mock_env_get, mock_is_windows):
...
class TestParentProcessInfo:
    ...
    def test_get_parent_process_info_windows_success(self, mock_run, mock_is_windows):
        ...
        mock_result.stdout = "powershell|C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe"
        mock_run.return_value = mock_result
...
class TestShellDetectionFromBehavior:
    ...
    @patch('subprocess.run')
    @patch('commandrex.executor.platform_utils.get_shell_version')
    def test_detect_shell_from_behavior_windows_cmd(self, mock_get_version, mock_run, mock_is_windows):
...
class TestBestGuessShell:
    ...
    @patch('commandrex.executor.platform_utils.get_shell_version')
    def test_determine_best_guess_windows_10(self, mock_get_version, mock_win_version, mock_is_macos, mock_is_windows):
    ...
    @patch('commandrex.executor.platform_utils.get_shell_version')
    def test_determine_best_guess_macos_catalina(self, mock_get_version, mock_mac_ver, mock_is_macos, mock_is_windows):
    ...
    @patch('commandrex.executor.platform_utils.is_macos')
    @patch('commandrex.executor.platform_utils.get_shell_version')
    def test_determine_best_guess_linux(self, mock_get_version, mock_is_macos, mock_is_windows):
...
class TestShellCapabilities:
    ...
    def test_get_shell_capabilities_fish(self, mock_supports_ansi):
        ...
        assert capabilities["command_aliases"] is True
        assert capabilities["array_support"] is True
        assert capabilities["process_substitution"] is False  # fish doesn't support process substitution
        assert capabilities["multiline_commands"] is True

    @patch('subprocess.run')
    @patch('commandrex.executor.platform_utils.supports_ansi_colors')
    def test_get_shell_capabilities_bash_process_substitution_test(self, mock_supports_ansi, mock_run):
...
class TestUtilityFunctions:
    ...
    @patch('commandrex.executor.platform_utils.is_windows')
    @patch('commandrex.executor.platform_utils.detect_shell')
    def test_get_command_prefix_windows_powershell(self, mock_detect_shell, mock_is_windows):
...
class TestShellStartupCommand:
    ...
    @patch('commandrex.executor.platform_utils.is_windows')
    @patch('commandrex.executor.platform_utils.detect_shell')
    def test_get_shell_startup_command_windows_powershell(self, mock_detect_shell, mock_is_windows):
    ...
    @patch('commandrex.executor.platform_utils.is_windows')
    @patch('commandrex.executor.platform_utils.detect_shell')
    def test_get_shell_startup_command_windows_cmd(self, mock_detect_shell, mock_is_windows):
    ...
    @patch('commandrex.executor.platform_utils.is_windows')
    @patch('os.environ.get')
    def test_get_shell_startup_command_unix_with_shell_env(self, mock_env_get, mock_is_windows):
    ...
    @patch('commandrex.executor.platform_utils.is_windows')
    @patch('os.environ.get')
    def test_get_shell_startup_command_unix_fallback(self, mock_env_get, mock_is_windows):
        """Test shell startup command on Unix with fallback."""
        mock_is_windows.return_value = False
        # Mock os.environ.get to return the default value when SHELL is not set
        mock_env_get.side_effect = lambda key, default=None: default if key == "SHELL" else None
...
class TestAnsiColorSupport:
    ...
    @patch('os.environ.get')
    @patch('sys.getwindowsversion')
    def test_supports_ansi_colors_dumb_terminal(self, mock_win_version, mock_env_get, mock_is_windows):
    ...
    def test_supports_ansi_colors_unix_tty(self, mock_isatty, mock_env_get, mock_is_windows):
    ...
    @patch('os.environ.get')
    @patch('sys.stdout.isatty')
    def test_supports_ansi_colors_unix_no_tty(self, mock_isatty, mock_env_get, mock_is_windows):
...
class TestPlatformUtilsEdgeCases:
    ...
    @patch('commandrex.executor.platform_utils.detect_shell_from_behavior')
    @patch('commandrex.executor.platform_utils.determine_best_guess_shell')
    def test_detect_shell_all_methods_fail(self, mock_best_guess, mock_behavior, mock_commands, mock_env):
