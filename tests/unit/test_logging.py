...
class TestSetupLogging:
    ...
    @patch('commandrex.executor.platform_utils.supports_ansi_colors')
    def test_setup_logging_colors_enabled_platform_no_support(self, mock_supports_colors):
    ...
    @patch('commandrex.executor.platform_utils.supports_ansi_colors')
    @patch('os.makedirs')
    def test_setup_logging_with_file_string_path(self, mock_makedirs, mock_supports_colors):
...
class TestInitializeLogging:
    ...
    @patch('commandrex.executor.platform_utils.supports_ansi_colors')
    def test_initialize_logging_default_settings(self, mock_supports_colors, mock_settings):
    ...
    @patch('commandrex.executor.platform_utils.supports_ansi_colors')
    @patch('os.makedirs')
    def test_initialize_logging_with_file(self, mock_makedirs, mock_supports_colors, mock_settings):
...
class TestLoggingEdgeCases:
    ...
    @patch('commandrex.executor.platform_utils.supports_ansi_colors')
    @patch('os.makedirs')
    def test_setup_logging_file_creation_error(self, mock_makedirs, mock_supports_colors):
